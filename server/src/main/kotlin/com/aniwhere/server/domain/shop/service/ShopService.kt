...
class ShopService(private val port: ShopPersistencePort) : ShopUseCase {
    ...
    override fun searchShops(regionId: Short?, categoryName: String?, keyword: String?, pageable: Pageable): Page<Shop> =
        port.findAll(regionId, categoryName, keyword, pageable)
