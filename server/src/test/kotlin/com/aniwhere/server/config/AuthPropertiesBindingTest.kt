...
class AuthPropertiesBindingTest {
    private val runner =
        ApplicationContextRunner()
            ...
            .withPropertyValues(
                ...
                "app.auth.toss.mtls.cert-path=/home/ubuntu/mtls/aniwheretlv2_public.crt",
                "app.auth.toss.mtls.key-path=/home/ubuntu/mtls/aniwheretlv2_private.key",
    ...
    fun `auth properties bind 성공`() {
        runner.run { context ->
            ...
            assertThat(props.toss.mtls.certPath).endsWith("aniwheretlv2_public.crt")
            assertThat(props.toss.mtls.keyPath).endsWith("aniwheretlv2_private.key")
