...
test('client API functions cover Swagger paths added for facets, favorites, auth, users, and shop reviews', () => {
  ...
  assert.doesNotMatch(shopReviews, /reviewMutationQuery/)
  assert.match(shopReviews, /formData\.append\('rating', String\(payload\.rating\)\)/)
  assert.match(shopReviews, /formData\.append\('content', payload\.content\)/)
